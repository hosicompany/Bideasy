...
const GLOSSARY = {
  ...
  'A값': '국민연금·건강보험·노인장기요양보험료, 퇴직공제부금비, 산업안전보건관리비 등 사후정산 비목 10종 합계(산재·고용보험 제외). 투찰가 공식에서 사정률을 적용하지 않고 그대로 더합니다. 2026-08부터 기초금액 API 구성요소 합계(tier0)로 자동 수집하며, 결측인 공고는 0으로 계산합니다.',
