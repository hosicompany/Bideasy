        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 20,
              fontWeight: FontWeight.w700,
              color: _user?.companyName?.isNotEmpty == true
                  ? AppColors.textMain
                  : AppColors.textSub,
            ),
          ),
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: _buildStatItem(
                    label: "시공능력",
                    value: _formatCurrency(_user?.capacityCost),
                    icon: Icons.account_balance_rounded,
      ...
      child: Column(
        ...
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            hint: Text(
              "선택해주세요",
              style: TextStyle(color: AppColors.textSub.withOpacity(0.5)),
            ),
            items: items
        ...
        child: Row(
          children: [
            Icon(
              icon,
              size: 20,
              color: isDestructive ? AppColors.dangerRed : AppColors.textSub,
            ),
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 15,
                  color: isDestructive ? AppColors.dangerRed : AppColors.textMain,
                ),
              ),
            ),
            if (value != null)
