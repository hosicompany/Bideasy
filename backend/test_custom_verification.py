...
# Since we are in backend dir, we can import directly if running as module, 
# or adjust path to include current dir
sys.path.append(os.path.abspath(os.path.dirname(__file__)))
# Also need parent of 'app' to be in path if we are running from inside backend
