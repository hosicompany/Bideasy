...
- Pro: 월 24,900원 / 연 239,000원(약 20% 할인). AI 분석 일 50회, Deep Analysis(HWP·PDF 첨부), 경쟁 강도 참고치, 투찰가 검증.
- Pro+: 월 49,900원 / 연 479,000원. Pro 전체 + AI 무제한, 기관 프로파일링, 사정률 분포 분석, 안전 투찰 가이드.
